...
# export
forecast_s01_v01_export <- forcast_s01_var01$mean
forecast_s01_v02_export <- forcast_s01_var02$mean
```
...
# export
forecast_s02_v02_export <- ts_s02_v02_forecast$mean
forecast_s02_v03_export <- ts_s02_v03_forecast$mean
```
...
For the sixth series we examined data for **Variable 06** and **Variable 07**.
